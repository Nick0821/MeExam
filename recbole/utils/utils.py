...
def get_model(model_name):
    ...
    model_module = None
    module_path = '.'.join(['recbole.model', model_file_name])
...
def calculate_valid_score(valid_result, valid_metric=None):
    ...
    # else:
    return valid_result['hit@10'] + valid_result['hit@20'] + valid_result['hit@5'] + valid_result['ndcg@10'] + valid_result['ndcg@20'] + valid_result['ndcg@5']
